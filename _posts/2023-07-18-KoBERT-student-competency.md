...
```
    ...
    [array(1.1017168, dtype=float32),
     ...
     array(7.8558305e-06, dtype=float32),
     array(9.885339e-06, dtype=float32),
     array(6.261426e-06, dtype=float32),
     array(1.3118714e-05, dtype=float32),
     array(0.0140598, dtype=float32),
     array(1.0198239e-05, dtype=float32),
     array(1.6118605e-05, dtype=float32),
     array(8.460791e-06, dtype=float32),
     array(7.3819647e-06, dtype=float32),
     array(6.7621127e-06, dtype=float32),
     array(1.0454551e-05, dtype=float32),
     array(6.5385802e-06, dtype=float32),
     array(9.107485e-06, dtype=float32),
     array(8.329657e-06, dtype=float32),
     array(7.608469e-06, dtype=float32),
     array(7.3134447e-06, dtype=float32),
     array(8.085314e-06, dtype=float32),
     array(1.1724015e-05, dtype=float32),
     array(8.937641e-06, dtype=float32),
     array(1.6264157e-05, dtype=float32),
     array(6.7710484e-06, dtype=float32),
     array(6.9111147e-06, dtype=float32),
     array(0.01633878, dtype=float32),
     array(1.0898486e-05, dtype=float32),
     array(6.8753557e-06, dtype=float32),
     array(7.331263e-06, dtype=float32),
     array(0.00037195, dtype=float32),
     array(8.481676e-06, dtype=float32),
     array(8.1608414e-05, dtype=float32),
     array(6.976683e-06, dtype=float32)]
